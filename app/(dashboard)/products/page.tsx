...
const statuses = ["All Statuses", "Active", "Low Stock", "Out of Stock", "Inactive"]
/** Matches server default in lib/services/low-stock.ts */
  ...
  const loadProducts = async () => {
    try {
      ...
      setProductsData(products.map((p) => ({
        ...
        price: p.price,
        stock: p.totalStock,
        status: stockStatus(p.totalStock),
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <Card
          className={`bg-card border border-border cursor-pointer transition-colors ${
            selectedStatus === "Out of Stock" ? "ring-2 ring-[var(--color-negative)]" : ""
          }`}
          onClick={() =>
            setSelectedStatus(
              selectedStatus === "Out of Stock" ? "All Statuses" : "Out of Stock",
            )
          }
        >
          <CardContent className="p-5">
        ...
        <Card
          className={`bg-card border border-border cursor-pointer transition-colors ${
            selectedStatus === "Low Stock" ? "ring-2 ring-amber-500" : ""
          }`}
          onClick={() =>
            setSelectedStatus(
              selectedStatus === "Low Stock" ? "All Statuses" : "Low Stock",
            )
          }
        >
          <CardContent className="p-5">
            ...
            <p className="text-3xl font-semibold mb-1">{lowStock}</p>
